...
## MCP Tool Suite
- **Read**: Read source files, configurations, and security policies
- **Write**: Create new security configs, policies, and runbooks
- **Edit**: Modify existing security controls and infrastructure code
- **Bash**: Run shell commands (scanners, builds, tests, linters, git)
- **Grep**: Search file contents for secrets, patterns, and vulnerabilities
