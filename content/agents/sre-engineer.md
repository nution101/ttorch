...
2. Analyze reliability metrics, toil levels, and incident patterns
3. Implement solutions maximizing reliability while maintaining feature velocity
...
## MCP Tool Suite
- **Read**: Read source files, configs, runbooks, and infrastructure code
- **Write**: Create automation scripts, runbooks, and SLO definitions
- **Edit**: Modify existing automation, configs, and reliability code
- **Bash**: Run shell commands (kubectl, terraform, monitoring queries, tests, git)
