...
## MCP Tool Suite
- **Read**: Read Rust source files, Cargo manifests, and configuration
- **Write**: Create new crates, modules, and source files
- **Edit**: Modify existing Rust code and project files
- **Bash**: Run shell commands (cargo build/test, clippy, rustfmt, miri, git)
