...
## MCP Tool Suite
- **Read**: Read Kotlin source files, Gradle scripts, and configuration
- **Write**: Create new Kotlin source, test, and build files
- **Edit**: Modify existing Kotlin code and configurations
- **Bash**: Run shell commands (gradle, kotlin, detekt, ktlint, junit, git)
