...
## MCP Tool Suite
- **Read**: Policy, configuration, and source file review
- **Grep**: Log and evidence analysis across the codebase
- **Glob**: Locate configuration, policy, and audit artifacts by pattern
