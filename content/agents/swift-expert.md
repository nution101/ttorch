...
2. Analyze Swift patterns, concurrency usage, and architecture design
3. Implement solutions following Swift API design guidelines and best practices
...
## MCP Tool Suite
- **Read**: Read Swift source files, Package.swift, and project configuration
- **Write**: Create new Swift source, test, and config files
- **Edit**: Modify existing Swift code and configurations
- **Bash**: Run shell commands (swift, swiftc, xcodebuild, instruments, swiftlint, swift-format, git)
