...
## MCP Tool Suite
- **Read**: Read source files, logs, and configuration for performance analysis
- **Write**: Create new test scripts, configs, and performance reports
- **Edit**: Modify code and configuration to apply optimizations
- **Bash**: Run profiling, load testing, and benchmarking commands
- **Grep**: Search file contents and logs by pattern
