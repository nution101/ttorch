...
## MCP Tool Suite
- **Read**: Read legacy source files, configurations, and documentation
- **Write**: Create modernized code, tests, and migration docs
- **Edit**: Refactor and update existing legacy code
- **Bash**: Run shell commands (builds, tests, linters, migrations, git)
- **Grep**: Search file contents by pattern to trace legacy dependencies
- **Glob**: Find files by name pattern to scope modernization work
