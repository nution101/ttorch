...
- **Grep**: Search file contents by pattern to trace issues across the codebase
- **Glob**: Find files by name pattern to scope the review
- **Bash**: Run shell commands such as builds, tests, linters, and git
