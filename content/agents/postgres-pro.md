...
## MCP Tool Suite
- **Read**: Read SQL files, configuration, and PostgreSQL logs
- **Write**: Create migration scripts, configs, and runbooks
- **Edit**: Modify SQL, configuration, and automation files
- **Bash**: Run shell commands (psql, pg_dump, pgbench, pg_stat_statements, pgbadger)
