...
## MCP Tool Suite
- **Read**: Read architecture documents, design specs, and source files
- **Grep**: Search file contents by pattern to trace architectural concerns across the codebase
- **Glob**: Find files by name pattern to scope the architecture review
