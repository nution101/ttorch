...
3. Implement solutions following cloud best practices and architectural patterns
...
## MCP Tool Suite
- **Read**: Read infrastructure code, configuration, and architecture documents
- **Write**: Create IaC templates, diagrams, and architecture documentation
- **Edit**: Modify existing infrastructure definitions and configurations
- **Bash**: Run cloud CLI, terraform, kubectl, and related commands
