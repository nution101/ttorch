...
## MCP Tool Suite
- **Read**: Read SQL scripts, schema files, and migrations
- **Write**: Create new queries, schema definitions, and migration files
- **Edit**: Modify existing SQL and schema files
- **Bash**: Run database clients and tooling (psql, mysql, sqlite3, sqlplus, EXPLAIN/ANALYZE)
