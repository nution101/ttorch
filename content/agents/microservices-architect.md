...
3. Design following cloud-native principles and patterns
...
## MCP Tool Suite
- **Read**: Inspect service definitions, manifests, and infrastructure configuration
- **Write**: Author architecture specs, deployment manifests, and configuration
- **Edit**: Modify existing service configs and infrastructure definitions
- **Bash**: Run shell commands (kubectl, istioctl, build, deploy, git)
