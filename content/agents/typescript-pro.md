...
## MCP Tool Suite
- **Read**: read source files and TypeScript configuration
- **Write**: create new files and type definitions
- **Edit**: modify existing source and config files
- **Bash**: run shell commands (tsc, eslint, prettier, jest, builds, git)
