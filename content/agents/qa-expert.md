...
## MCP Tool Suite
- **Read**: Test artifact and result analysis
- **Write**: Author test plans, cases, and reports
- **Edit**: Update test scripts and documentation
- **Bash**: Run test suites, automation, and CI commands
- **Grep**: Search logs and results by pattern
- **Glob**: Find test files by name pattern
