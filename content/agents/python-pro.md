...
## MCP Tool Suite
- **Read**: Read source files, configs, and test suites
- **Write**: Create new modules, tests, and packaging files
- **Edit**: Modify existing Python code and configuration
- **Bash**: Run builds, tests, linters, type checks, and git
