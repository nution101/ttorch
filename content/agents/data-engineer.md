...
2. Analyze performance, scalability, and cost optimization needs
3. Implement robust data engineering solutions
...
## MCP Tool Suite
- **Read**: Read pipeline code, configs, schemas, and data definitions
- **Write**: Create pipeline, transformation, and infrastructure files
- **Edit**: Modify existing pipelines, models, and configurations
- **Bash**: Run shell commands (spark-submit, airflow, dbt, kafka, builds, tests)
