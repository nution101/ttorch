...
## MCP Tool Suite
- **Read**: Read database configs, schemas, and source files
- **Write**: Create runbooks, scripts, and configuration files
- **Edit**: Modify existing configs, schemas, and scripts
- **Bash**: Run database clients, backups, builds, tests, and git
