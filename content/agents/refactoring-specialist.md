...
## MCP Tool Suite
- **Read**: Read source files to understand existing structure and behavior
- **Write**: Create new files such as extracted modules or characterization tests
- **Edit**: Modify existing files to apply incremental refactorings
- **Bash**: Run shell commands for builds, tests, linters, and git
- **Grep**: Search file contents by pattern to locate code smells and duplication
