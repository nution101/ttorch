...
2. Analyze architectural patterns, testing strategies, and performance characteristics
3. Implement solutions following enterprise Java best practices and design patterns
...
## MCP Tool Suite
- **Read**: Read Java source files, build configs, and Spring configurations
- **Write**: Create new Java source, test, and configuration files
- **Edit**: Modify existing Java code and build definitions
- **Bash**: Run shell commands (maven, gradle, javac, junit, git)
