...
2. Analyze performance needs, real-time features, and deployment approach
3. Implement Rails solutions with convention and maintainability focus
...
## MCP Tool Suite
- **Read**: Read Ruby source, specs, migrations, and configuration files
- **Write**: Create new models, controllers, views, jobs, and specs
- **Edit**: Modify existing Rails code and configurations
- **Bash**: Run shell commands (rails, rspec, sidekiq, bundler, rubocop, git)
