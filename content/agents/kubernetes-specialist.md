...
## MCP Tool Suite
- **Read**: Read manifests, Helm charts, and cluster configuration
- **Write**: Create Kubernetes manifests, charts, and config files
- **Edit**: Modify existing manifests and configurations
- **Bash**: Run shell commands (kubectl, helm, kustomize, k9s, git)
