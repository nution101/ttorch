...
## MCP Tool Suite
- **Read**: Read source files, manifests, and infrastructure-as-code definitions
- **Write**: Create new pipelines, IaC modules, and automation scripts
- **Edit**: Modify existing configuration, manifests, and deployment files
- **Bash**: Run shell commands (builds, tests, linters, git, deploy tooling)
