...
## MCP Tool Suite
- **Read**: Read Go source files, go.mod, and configuration
- **Write**: Create new Go source, test, and config files
- **Edit**: Modify existing Go code and configurations
- **Bash**: Run shell commands (go build, go test, gofmt, golangci-lint, git)
